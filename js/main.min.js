...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var accordion = document.querySelectorAll('[data-name="accordion"]');
  ...
  accordion.forEach(function (element) {
    element.querySelector('.accordion__title').addEventListener('click', function () {
  ...
  var mainScreenButton = document.querySelector('[data-name="main-screen-button"]');
  ...
  changeButtonText();
  var catalogTitle = document.querySelector('[data-name="catalog-title"]');
  ...
  var showMoreButton = document.querySelector('[data-name="about-button"]');
  var moreText = document.querySelector('[data-more-text]');
  var styleMoreText = window.getComputedStyle(moreText);
  var lineHeight = styleMoreText.getPropertyValue('line-height');
  var fontSize = styleMoreText.getPropertyValue('font-size');
  var textHeight;
  var calcTextHeight = function calcTextHeight() {
    switch (true) {
